...
Mat4x4 FBXModelComponent::GetBoneTransform(const String& boneName) const
{
	if (!m_skeleton) return Mat4x4::Identity();

	aiMatrix4x4 aiMat = m_skeleton->GetBoneGlobalTransform(boneName);
